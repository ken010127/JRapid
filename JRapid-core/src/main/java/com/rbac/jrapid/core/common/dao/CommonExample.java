...
//	private static SimpleDateFormat formatYYYYMMDD=new SimpleDateFormat("yyyy-MM-dd");
    ...
    public CommonExample andDatebetween(String columnName,Object begindate,Object enddate,String begin_timeFormat,String end_timeFormat) {
        firstCriteria().datebetween(CommonExample.AND,columnName,begindate,enddate,begin_timeFormat,end_timeFormat);
        return this;
    }
    ...
    public static String getBeginDate(Object begindate) {
        ...
        if ((begindate instanceof String)&&(begindate.toString().trim().length()>0)) {
            if (datepattern.matcher(begindate.toString()).matches()) {
                ...
                if (flag) {
                    str1=DateUtil.dateToStr(new Date(Long.parseLong(begindate.toString())), "yyyy_MM_dd");
                }
            }
        } else if (begindate instanceof Date) {
            str1=DateUtil.dateToStr((Date) begindate, "yyyy_MM_dd")+" 23:59:59";
        } else if ((begindate instanceof Integer)||(begindate instanceof Long)) {
            str1=DateUtil.dateToStr(new Date(Long.parseLong(begindate.toString())),"yyyy_MM_dd")+" 23:59:59";
        }
    ...
    public  static class Criteria implements Serializable{
        ...
        public Criteria datebetween(String andor, String columnName, Object begindate, Object enddate, String begin_timeFormat,String end_timeFormat) {
            ...
            if (begindate!=null) {
                if ((begindate instanceof String)&&(begindate.toString().trim().length()>0)) {
                    if (datepattern.matcher(begindate.toString()).matches()) {
                        str1=begindate+begin_timeFormat;
                    } else if (datetimepattern.matcher(begindate.toString()).matches()) {
                        str1=begindate.toString();
                    } else {
                        boolean flag=true;
