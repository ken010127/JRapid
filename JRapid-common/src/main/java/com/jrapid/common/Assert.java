 ...
 * 
 */
package com.jrapid.common;


import com.jrapid.common.exception.UnexpectedFailureException;
import com.jrapid.common.exception.UnreachableCodeException;
...
public abstract class Assert {
    ...
    public static <T> T unexpectedException(Throwable e, String message, Object...args) {
        RuntimeException exception =
                ExceptionType.UNEXPECTED_FAILURE.newInstance(getMessage(message, args,
    ...
    public static <T> T fail(String message, Object...args) {
        throw ExceptionType.UNEXPECTED_FAILURE.newInstance(getMessage(message, args, "[Assertion failed] - unexpected failure"));
    }
