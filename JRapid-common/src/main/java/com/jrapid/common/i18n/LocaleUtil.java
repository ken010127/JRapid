package com.jrapid.common.i18n;
...
import com.jrapid.common.ClassLoaderUtil;
import com.jrapid.common.CollectionUtil;
import com.jrapid.common.Emptys;
import com.jrapid.common.StringUtil;
import com.jrapid.common.io.StreamUtil;
 ...
 * 用来处理地域和字符编码的工具类。
 * <p>
 * 由于系统locale和charset是不可靠的，不同的环境可能会有不同的系统设置，因此应用程序最好不要依赖这个系统值。 <code>LocaleUtil</code>提供了一个方案，可以“修改”默认locale和charset。
 * </p>
 * <p>
