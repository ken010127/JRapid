 ...
 * 
 */
package com.jrapid.common.test;

import static com.jrapid.common.Assert.fail;
...
import com.jrapid.common.Assert;
...
public abstract class TestUtil {
    ...
    public static Field getAccessibleField(Class<?> targetType, String fieldName) {
        Assert.assertNotNull(targetType,"missing targetType");
        ...
        Assert.assertNotNull(field,"field " + fieldName + " not found in " + targetType);
    ...
    public static Method getAccessibleMethod(Class<?> targetType, String methodName, Class<?>[] argTypes) {
        ...
        Assert.assertNotNull(method,"method " + methodName + " not found in " + targetType);
