 ...
 * 
 */
package com.jrapid.common.apache;

import com.jrapid.common.ClassUtil;
import com.jrapid.common.ObjectUtil;
import com.jrapid.common.SystemUtil;
...
public abstract class ToStringStyle {
    ...
    /**
     * The default toString style. Using the Using the <code>Person</code> example from {@link ToStringBuffer}, the
    ...
    /**
     * The multi line toString style. Using the Using the <code>Person</code> example from {@link ToStringBuffer}, the
     * output would look like this:
     * 
     * <pre>
     * Person@182f0db[
    ...
    /**
     * The no field names toString style. Using the Using the <code>Person</code> example from {@link ToStringBuffer},
    ...
    /**
     * The short prefix toString style. Using the <code>Person</code> example from {@link ToStringBuffer}, the output
    ...
    /**
     * The simple toString style. Using the Using the <code>Person</code> example from {@link ToStringBuffer}, the
     * output would look like this:
     * 
     * <pre>
     * John Doe,33,false
